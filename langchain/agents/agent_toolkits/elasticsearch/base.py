...
from langchain.agents.agent_toolkits.elasticsearch.prompt import ES_DSL_PREFIX, ES_DSL_SUFFIX
...
def create_elasticsearch_agent(
    ...
    toolkit: ElasticsearchDatastoreToolkit,
    callback_manager: Optional[BaseCallbackManager] = None,
    prefix: str = ES_DSL_PREFIX,
    ...
    **kwargs: Dict[str, Any],
    ...
    """Construct Elasticsearch agent from an LLM and tools."""
